_base_ = ['./aerialformer_tiny_512x512_gbg.py']
...
data = dict(samples_per_gpu=4, workers_per_gpu=4) # 2 GPUs x 4 samples/gpu = 8 batch size #####4x4 var default, använder 16780 mb vram, 6st 20837mb (får sämre prestanda än 4st)
